...
function ed(){
	...
	if($("input[name='ids']:checked").attr("checked")!="checked"){
		alert('请勾选一项信息');
		return;
	}
	$('#checkbox-id').attr('checked')
		if(confirm("确定要删除所选项目？")){
			...
			$.ajax({ 
				...
				url: "DelUsers", 
				dataType:"text",
				data: {uidsa:checkedList.toString()}, 
...
$(function(){
	...
	$(".modifyUser").on("click",function(){
		var obj = $(this);
		window.location.href=path+"/UsermodifyServlet?method=modify&uid="+ obj.attr("userid");
	});
