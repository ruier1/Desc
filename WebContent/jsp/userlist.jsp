...
<div class="right">
	...
	<div class="search">
		<form method="get"
			action="${pageContext.request.contextPath }/FuzzyQuery_Servlet">
	...
	<table class="providerTable" cellpadding="0" cellspacing="0">
		&nbsp;&nbsp;&nbsp;
		<input type="button" id="ddx" name="id" onclick="ed()" value="删除信息">
		<tr class="firstTr">
			<th width="10%"><input id="sel_1" onchange="selectAll()"
				type="checkbox" value="1" />全选/全不选</th>
			<th width="10%">用户编码</th>
			<th width="20%">用户名称</th>
			<th width="10%">性别</th>
			<th width="10%">年龄</th>
		...
		<c:forEach var="user" items="${userList}" varStatus="status">
			<tr>
				<td><input type="checkbox" name="ids" class="ids" id="ids"
					value="${user.id}" /></td>
